...
factory('TokenHandler', [ '$http', 'Base64', function($http, Base64) {
    ...
    tokenHandler.getCredentials = function ( username, secret, salt) {
        // Generate nonce
    ...
    var tokenWrapper = function ( resource, action ) {
        ...
        resource[action] = function ( data, success, error ) {
            if ( (typeof data.username != 'undefined') && (typeof data.secret != 'undefined') && (typeof data.salt != 'undefined') ) {
                $http.defaults.headers.common['X-WSSE'] = tokenHandler.getCredentials(data.username, data.secret, data.salt);
